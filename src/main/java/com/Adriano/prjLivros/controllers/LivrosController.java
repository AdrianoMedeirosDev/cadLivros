package com.Adriano.prjLivros.controllers;
...
import com.Adriano.prjLivros.services.LivrosService;
...
public class LivrosController {
	...
	public ResponseEntity<List<Livros>> getAllLivros(RequestEntity<Void> requestEntity) {
		...
		return ResponseEntity.status(HttpStatus.OK).header("Method", method).header("Method", method).header("Content-Type", contentType).body(livros);
	}
